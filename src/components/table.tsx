...
const MyTable: FC<TableProps> = ({self, includePageNav, disableSearch}: TableProps) => {
            ...
            return (
                <TableHead>
                    <TableRow>
                        ...
                        ).map((tableHead: string, index: number) => (
                ...
                <Table stickyHeader className={classes.table} aria-label="custom pagination table">
                    ...
                    <TableBody>
                        {(data
                            ...
                            <TableRow style={index % 2 ? {background: "lightgrey"} : {background: "white"}}
                                      key={"row" + index}>

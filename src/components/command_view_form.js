...
//        }
        ...
        function CreateJobRequest(self){
            if(self.state.errors.length > 0 ){
                ...
                return (
                    <Button component={RouterLink} to={{pathname: "/jobs/create", state: {request: self.state.model }}} variant="contained" color="primary">
                            Create Job
                    </Button>
                )
            }
...
//            let temp_data = {};
        ...
        <div>
            ...
            <JsonForms
              ...
              renderers={[...materialRenderers, {tester: AlertTester, renderer: AlertForm}, {tester: DictionaryTester, renderer: DictionaryControl}]}
              cells={materialCells}
              onChange={({ data, errors }) => {onChange(self, data, errors)}}
            />

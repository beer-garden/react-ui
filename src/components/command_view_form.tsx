...
const CommandViewForm: FC<CommandViewFormProps> = ({self, schema, uischema, initialData}: CommandViewFormProps) => {
...
//        }
    ...
    function onChange(self: any, data: any, errors: any) {
        ...
        for (let i in errors) {
            ...
            let parameter = self.command.parameters.find((para: any) => para['key'] === path) || {}

...
class GardensService {
    ...
    UISCHEMA = {
        ...
        "elements": [
            {
                "type": "Control", "scope": "#/properties/connection_type"
            },
            {
                "type": "Categorization",
                "elements": [
                    {
                        ...
                        "elements": [
                            ...
                            {"type": "Control", "scope": "#/properties/http/properties/url_prefix"},
                            {"type": "Control", "scope": "#/properties/http/properties/ssl"},
                            {"type": "Control", "scope": "#/properties/http/properties/ca_cert"},
                            {"type": "Control", "scope": "#/properties/http/properties/ca_verify"},
                            {"type": "Control", "scope": "#/properties/http/properties/client_cert"},
                        ]
                    },
                    {
                        "type": "Category",
                        ...
                        "elements": [
                            ...
                            {"type": "Control", "scope": "#/properties/stomp/properties/send_destination"},
                            {"type": "Control", "scope": "#/properties/stomp/properties/subscribe_destination"},
                            {"type": "Control", "scope": "#/properties/stomp/properties/username"},
                            {"type": "Control", "scope": "#/properties/stomp/properties/password"},
                            {"type": "Control", "scope": "#/properties/stomp/properties/ssl/properties/use_ssl"},
                            {"type": "Control", "scope": "#/properties/stomp/properties/ssl/properties/ca_cert"},
                            {"type": "Control", "scope": "#/properties/stomp/properties/ssl/properties/client_cert"},
                            {"type": "Control", "scope": "#/properties/stomp/properties/ssl/properties/client_key"},
                            {"type": "Control", "scope": "#/properties/stomp/properties/headers"},
                        ]
                    },
    ...
    getGarden(self, garden_name) {
        let url = '/api/v1/gardens';
        axios.get(url + '/' + garden_name)
            .then(response => {
                self.successCallback(response);
            })
    }

    syncAllGardens(gardens) {

    }

    syncGarden(garden_name) {
        let url = '/api/v1/gardens';
        axios.patch(url + '/' + garden_name, {"operation": "sync", "path": "", "value": ""});
    }

    updateGardenConfig(garden) {
        let url = '/api/v1/gardens';
        axios.patch(url + '/' + garden.name, {operation: 'config', path: '', value: garden});
    }

    deleteGarden(garden_name) {
        let url = '/api/v1/gardens';
    ...
    formToServerModel = function (model, form) {

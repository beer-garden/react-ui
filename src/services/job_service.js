...
//	    url = url.replace('{start}', start).replace('{length}', length);
      ...
      getTrigger(triggerType, formModel) {
          if (triggerType === 'date') {
            return {
      ...
      formToServerModel = function(formModel, requestTemplate) {
          let serviceModel = {};
          ...
          serviceModel['trigger'] = this.getTrigger(formModel['trigger_type'], formModel);
      ...
      TRIGGER_TYPES = ['cron', 'date', 'interval', 'file'];
        ...
        getRequiredKeys = function(triggerType) {
          if (triggerType === 'cron') {
            let requiredKeys = [];
                                       ...
                                       "elements": [
                                         ...
                                         },
                                         {
                                           ...
                                           "elements": [
                                             ...
                                             {
                                               "type": "Control", "scope": "#/properties/week"
                                             },
                                             {
                                               "type": "Control", "scope": "#/properties/second"
                                             },
                                             {
                                               "type": "Control", "scope": "#/properties/cron_jitter"
                                             },
                                           ]
                                         },
                                         {
                                       ...
                                       'elements': [
                                         {
                                           ...
                                           'elements': [
                                             ...
                                             { "type": "Control", "scope": "#/properties/interval_reschedule_on_finish" },
                                           ],
                                         },
                                         {
                                           'type': 'HorizontalLayout',
                                           'elements': [
                                             { "type": "Control", "scope": "#/properties/interval_start_date" },

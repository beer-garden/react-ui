                    ...
                    <Box px={2}>
                        <Switch>
                            <Route path="/systems/:namespace/:system_name/:version/commands/:command_name/"
                                   component={(routeProps: any) => <CommandViewApp
                                       systems={this.state.systems} {...routeProps} />}/>
                            <Route path="/systems/:namespace/:system_name/:version/"
                                   component={(routeProps: any) => <CommandsApp
                                       systems={this.state.systems} {...routeProps} />}/>
                            <Route path="/systems/:namespace/:system_name/" component={(routeProps: any) => <CommandsApp
                                systems={this.state.systems} {...routeProps} />}/>
                            <Route path="/systems/:namespace/" component={(routeProps: any) => <CommandsApp
                                systems={this.state.systems} {...routeProps} />}/>

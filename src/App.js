      ...
      render() {
        if(this.state.systems){
            ...
            <Box>
                ...
                <Box px={2} >
                    <Switch>
                        <Route path="/systems/:namespace/:system_name/:version/commands/:command_name/" component={routeProps => <CommandViewApp systems={this.state.systems} {...routeProps} /> } />
                        <Route path="/systems/:namespace/:system_name/:version/" component={routeProps => <CommandsApp systems={this.state.systems} {...routeProps} /> } />
                        <Route path="/systems/:namespace/:system_name/" component={routeProps => <CommandsApp systems={this.state.systems} {...routeProps} /> } />
                        <Route path="/systems/:namespace/" component={routeProps => <CommandsApp systems={this.state.systems} {...routeProps} /> } />
                        <Route path="/systems" component={() => <SystemsApp systems={this.state.systems}/>  } />
                        <Route path="/admin/systems" component={() => <SystemsAdminApp systems={this.state.systems} />} />
                        <Route path="/admin/gardens/:garden_name/" component={routeProps => <GardenViewApp {...routeProps} />} />
